            ...
            <table class="table">
                ...
                <?php foreach ($departements as $d) { ?>
                    <tr>
                        ...
                        <td><a href="/departements/admin_delete/<?= $d->id ?>" onclick="return confirm('Voulez-vous vraiment supprimer ce département?');"><i class="far fa-trash-alt"></i></a></td>
                    </tr>
                <?php } ?>
                <tr>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function filterTable() {
            ...
            rows.forEach((row) => {
                ...
                const departmentNameText = row.querySelector('td:nth-child(2)').textContent.toLowerCase();

                const searchMatch = idText.includes(searchText) || departmentNameText.includes(searchText);
