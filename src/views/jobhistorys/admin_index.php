        ...
        <div class="col mt-3">
            ...
            <table class="table">
                ...
                <tr class="bg-danger">
                    ...
                    <th scope="col" class="sortable">Date de début<i class="fas fa-sort"></i></th>
                    <th scope="col" class="sortable">Date de fin<i class="fas fa-sort"></i></th>
                ...
                <?php foreach ($jobhistorys as $j) { ?>
                    <tr>
                        ...
                        <td><a href="/jobhistorys/admin_delete/<?= $j->id ?>" onclick="return confirm('Voulez-vous vraiment supprimer cette jobhistory?');"><i class="far fa-trash-alt"></i></a></td>
                    </tr>
                <?php } ?>
                <tr>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function filterTable() {
            ...
            rows.forEach((row) => {
                ...
                const startDateText = row.querySelector('td:nth-child(2)').textContent.toLowerCase();
                const endDateText = row.querySelector('td:nth-child(3)').textContent.toLowerCase();

                const searchMatch = idText.includes(searchText) || startDateText.includes(searchText) || endDateText.includes(searchText);
